...
data:extend(
{
	-- 
	{
		...
		results = {
			{ type = "item", name = "yir_lsw_r790red", amount = 1.0, },
		},
		main_product = "yir_lsw_r790red",
		order = "lsw1", group = "yuoki_railway", subgroup = "yir_locomotives_nslong",
	},	

	{
		type="item", name="yir_lsw_r790red", icon="__z_yira_yuokirails__/graphics/sw-dkred-icon.png",
...

	{
		type = "locomotive",
		name = "yir_lsw_r790red",
		icon = "__z_yira_yuokirails__/graphics/sw-dkred-icon.png",icon_size = 32,
