...
data:extend(
{
	...
	{
		type="item-with-entity-data", name="z_yira_4a_cw_steel", icon="__z_yira_yuokirails__/graphics/4a_steel_icon.png", 
	...
	},
	{
		type = "cargo-wagon",
		name = "z_yira_4a_cw_steel",
		icon = "__z_yira_yuokirails__/graphics/4a_steel_icon.png",icon_size = 32,
